...
namespace Abbey.PdfProcessor.RealStatementProcessor.Parsers {
    internal class GuggenheimPdfParser :PdfParser {
        /// <summary>
        ...
        public static ParseOutput ParsePdf ( string pdfFilePath ) {
            try {
                return ParsePdf( pdfFilePath, "Guggenheim.ConverterX" );
            }
            catch (Exception e) {
                var errorMessage = new StringBuilder();
                errorMessage.AppendFormat( "Error Parsing Guggenheim PDF: {0}", pdfFilePath );
